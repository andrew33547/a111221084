...
public class MainActivity extends AppCompatActivity {
  ...
  class ResultContract extends ActivityResultContract<Boolean, String>{
      ...
      public Intent createIntent(@NonNull Context context, Boolean input) {
          ...
          bundle.putString("OPERAN001",((EditText)findViewById(R.id.txtOpd1)).getText().toString());
          bundle.putString("OPERAN002",((EditText)findViewById(R.id.txtOpd2)).getText().toString());
